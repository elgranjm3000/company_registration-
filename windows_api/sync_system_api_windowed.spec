...
# Spec file para compilar sync_system_api.py SIN CONSOLA (modo producción)
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        # Notificaciones Windows (nativas, sin win10toast)
        'pywin32',
        'pywin32.win32api',
        'pywin32.win32con',
        'pywin32.win32gui',
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=False,  # SIN CONSOLA - Modo producción (sin ventana negra)
