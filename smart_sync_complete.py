...
class SmartSyncComplete:
    ...
    def detectar_cambios_customers_mysql(self) -> Dict[str, List]:
        ...
        try:
            ...
            # 🚀 OPTIMIZACIÓN: Cargar TODOS los hashes de customers_mysql en memoria en UNA sola query
            self._log("  🔍 Cargando hashes de sync_hashes en memoria...", "debug")
            query_todos_hashes = """
            ...
            for customer in customers_dict:
                ...
                hash_guardado_hash = hashes_en_memoria.get(str(customer_id))
        ...
        try:
            ...
            if total_nuevos > 0:
                ...
                if batch_data:
                    ...
                    batch_size = 1000  # Insertar de 1000 en 1000 (balance óptimo para MySQL)
            ...
            if total_modificados > 0:
                ...
                if batch_data:
                    ...
                    # Dividir en lotes más pequeños para mostrar progreso
                    batch_size = 1000  # Actualizar de 1000 en 1000 (balance óptimo para MySQL)
                    start_time = time.time()
    ...
    def sincronizar_customers_mysql(self, cambios: Dict[str, List]):
        ...
        # Calcular total para progreso
        total_cambios = len(cambios['nuevos']) + len(cambios['modificados'])
        batch_size = 1000  # Insertar/actualizar de 1000 en 1000 (balance óptimo para MySQL)
