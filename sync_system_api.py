        ...
        try:
            ...
            create_trigger_query = """
                ...
                CREATE TRIGGER tr_products_stock_mark_deleted_sync_hashes
                    AFTER DELETE ON products_stock
                    FOR EACH ROW
...
"""
    ...
    def sync_all(self) -> dict:
        ...
        # Merge order stats into quotes stats
    ...
    def _mostrar_ventana_carga_api(self, api_key):
        ...
        def ejecutar_sync():
            ...
            try:
                ...
                sync_queue.put({'type': 'entity', 'entity': 'stores', 'status': 'pending', 'detail': 'Pendiente...'})
                sync_queue.put({'type': 'entity', 'entity': 'locations', 'status': 'pending', 'detail': 'Pendiente...'})
                sync_queue.put({'type': 'entity', 'entity': 'products-stock', 'status': 'pending', 'detail': 'Pendiente...'})
